...
/*   Updated: 2021/01/05 07:04:42 by lmartins         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_update_player(t_parameters *info)
{
	...
	info->player->pos_x += cos(info->player->rotation_angle) * move_step;
	info->player->pos_y += sin(info->player->rotation_angle) * move_step;
}