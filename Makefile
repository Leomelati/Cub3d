...
#    Updated: 2021/02/02 07:45:49 by lmartins         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
CUB_DIR = ./src
CUB = $(CUB_DIR)/main.c $(CUB_DIR)/free.c $(CUB_DIR)/init.c $(CUB_DIR)/key.c $(CUB_DIR)/player.c $(CUB_DIR)/map.c $(CUB_DIR)/rays.c
