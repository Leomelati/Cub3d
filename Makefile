...
CUB_DIR = ./src
CUB = $(CUB_DIR)/main.c $(CUB_DIR)/texture.c $(CUB_DIR)/free.c $(CUB_DIR)/init.c $(CUB_DIR)/key.c $(CUB_DIR)/player.c $(CUB_DIR)/map.c $(CUB_DIR)/rays.c $(CUB_DIR)/auxiliar.c $(CUB_DIR)/error.c $(CUB_DIR)/parse.c $(CUB_DIR)/rays_intercept.c $(CUB_DIR)/wall.c $(CUB_DIR)/ft_free_functions.c $(CUB_DIR)/auxiliar2.c
