...
CUB_DIR = ./src
CUB = $(CUB_DIR)/main.c $(CUB_DIR)/free.c $(CUB_DIR)/init.c $(CUB_DIR)/key.c $(CUB_DIR)/player.c $(CUB_DIR)/map.c $(CUB_DIR)/rays.c $(CUB_DIR)/line.c $(CUB_DIR)/auxiliar.c
